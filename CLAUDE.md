...
invoice site (`cmd/invoice`). See `docs/design/refactor.md` and
`docs/design/time_reporting_plan.md` for the design.
...
PDFs with reportlab. See `docs/design/printPlan.md` and `schedule_listener/README.md`.

## Docs
- `docs/design/` — plans + rationale: `refactor.md` (why Go), `time_reporting_plan.md`
  (punch/timesheet design), `printPlan.md` (schedule printing), `quickbooks_plan.md`
  (QBO integration, not built)
...
- `.claude/skills/` — on-demand task guides (see § Skills)
